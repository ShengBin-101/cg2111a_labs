...
void rightISR()
{
  if (dir == FORWARD){
    rightForwardTicks++;
    //float rightForwardRev = rightForwardTicks / COUNTS_PER_REV;
    //float rightForwardDist = rightForwardRev * WHEEL_CIRC;
  }
  if(dir == BACKWARD){
    rightReverseTicks++;
    //float rightReverseRev = rightReverseTicks / COUNTS_PER_REV;
    //float rightReverseDist = rightReverseRev * WHEEL_CIRC;
  }
  if(dir == LEFT){
...
//  float rightForwardDist = rightRev * WHEEL_CIRC;
